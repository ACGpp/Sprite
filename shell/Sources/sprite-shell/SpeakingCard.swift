...
final class SpeakingCard: NSPanel {
	...
	private let replyButton = NSButton(title: "回一句", target: nil, action: nil)
	private let dismissButton = NSButton(title: "知道了", target: nil, action: nil)
	...
	init() {
		...
		let who = NSTextField(labelWithString: "它")
